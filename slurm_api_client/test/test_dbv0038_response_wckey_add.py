...
class TestDbv0038ResponseWckeyAdd(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ResponseWckeyAdd:
        """Test Dbv0038ResponseWckeyAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ResponseWckeyAdd`
        """
        model = Dbv0038ResponseWckeyAdd()
        if include_optional:
    ...
    def testDbv0038ResponseWckeyAdd(self):
        """Test Dbv0038ResponseWckeyAdd"""
