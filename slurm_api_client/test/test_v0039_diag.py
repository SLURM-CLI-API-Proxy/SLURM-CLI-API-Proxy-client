    ...
    def make_instance(self, include_optional) -> V0039Diag:
        ...
        if include_optional:
            return V0039Diag(
                ...
                statistics = openapi_client.models.v0/0/39_stats_msg.v0.0.39_stats_msg(
                    parts_packed = 56, 
                    req_time = 56, 
                    req_time_start = 56, 
                    ...
                    rpcs_by_message_type = [
                        openapi_client.models.v0_0_39_stats_msg_rpcs_by_type_inner.v0_0_39_stats_msg_rpcs_by_type_inner(
                            message_type = '', 
                            type_id = 56, 
                            count = 56, 
                            average_time = 56, 
                    ...
                    rpcs_by_user = [
                        openapi_client.models.v0_0_39_stats_msg_rpcs_by_user_inner.v0_0_39_stats_msg_rpcs_by_user_inner(
                            user = '', 
                            user_id = 56, 
                            count = 56, 
                            average_time = 56, 
