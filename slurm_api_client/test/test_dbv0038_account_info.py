...
class TestDbv0038AccountInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038AccountInfo:
        """Test Dbv0038AccountInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038AccountInfo`
        """
        model = Dbv0038AccountInfo()
        if include_optional:
    ...
    def testDbv0038AccountInfo(self):
        """Test Dbv0038AccountInfo"""
