...
class TestDbv0038ResponseClusterDelete(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ResponseClusterDelete:
        """Test Dbv0038ResponseClusterDelete
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ResponseClusterDelete`
        """
        model = Dbv0038ResponseClusterDelete()
        if include_optional:
    ...
    def testDbv0038ResponseClusterDelete(self):
        """Test Dbv0038ResponseClusterDelete"""
