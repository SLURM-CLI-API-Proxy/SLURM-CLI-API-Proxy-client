    ...
    def make_instance(self, include_optional) -> V0038JobsResponse:
        ...
        if include_optional:
            return V0038JobsResponse(
                ...
                jobs = [
                    openapi_client.models.v0/0/38_job_response_properties.v0.0.38_job_response_properties(
                        account = '', 
                        accrue_time = 56, 
                        admin_comment = '', 
                        array_job_id = 56, 
                        ...
                        group_id = 56, 
                        job_id = 56, 
                        job_resources = openapi_client.models.v0/0/38_job_resources.v0.0.38_job_resources(
                            nodes = '', 
                            allocated_cpus = 56, 
                            allocated_hosts = 56, 
                            allocated_nodes = [
