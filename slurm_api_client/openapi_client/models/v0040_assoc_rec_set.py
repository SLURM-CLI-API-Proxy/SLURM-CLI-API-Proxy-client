...
class V0040AssocRecSet(BaseModel):
    ...
    V0040AssocRecSet
    """ # noqa: E501
    comment: Optional[StrictStr] = Field(default=None, description="Comment for the association")
    defaultqos: Optional[StrictStr] = Field(default=None, description="Which QOS id is this association default")
    ...
    fairshare: Optional[StrictInt] = Field(default=None, description="Number of shares allocated to this association")
