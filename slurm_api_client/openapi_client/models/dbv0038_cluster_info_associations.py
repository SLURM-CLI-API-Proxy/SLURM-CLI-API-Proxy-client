...
class Dbv0038ClusterInfoAssociations(BaseModel):
    """
    Information about associations
    """ # noqa: E501
    root: Optional[Dbv0038AssociationShortInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "root": Dbv0038AssociationShortInfo.from_dict(obj["root"]) if obj.get("root") is not None else None
        })
        return _obj
