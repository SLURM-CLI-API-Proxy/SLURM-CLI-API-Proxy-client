...
class Dbv0038AssociationMaxJobs(BaseModel):
    """
    Max jobs settings
    """ # noqa: E501
    per: Optional[Dbv0038AssociationMaxJobsPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": Dbv0038AssociationMaxJobsPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
