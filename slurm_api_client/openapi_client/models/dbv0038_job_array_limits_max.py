...
class Dbv0038JobArrayLimitsMax(BaseModel):
    """
    Limits on array settings
    """ # noqa: E501
    running: Optional[Dbv0038JobArrayLimitsMaxRunning] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "running": Dbv0038JobArrayLimitsMaxRunning.from_dict(obj["running"]) if obj.get("running") is not None else None
        })
        return _obj
