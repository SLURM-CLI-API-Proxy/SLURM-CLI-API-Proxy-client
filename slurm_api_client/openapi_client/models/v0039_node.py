...
class V0039Node(BaseModel):
    ...
    external_sensors: Optional[V0039ExtSensorsData] = None
    extra: Optional[StrictStr] = None
    power: Optional[V0039PowerMgmtData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "external_sensors": V0039ExtSensorsData.from_dict(obj["external_sensors"]) if obj.get("external_sensors") is not None else None,
            "extra": obj.get("extra"),
            "power": V0039PowerMgmtData.from_dict(obj["power"]) if obj.get("power") is not None else None,
