...
class Dbv0038JobExitCode(BaseModel):
    """
    Dbv0038JobExitCode
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Job exit status")
    return_code: Optional[StrictInt] = Field(default=None, description="Return code from parent process")
    signal: Optional[Dbv0038JobExitCodeSignal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signal": Dbv0038JobExitCodeSignal.from_dict(obj["signal"]) if obj.get("signal") is not None else None
        })
        return _obj
