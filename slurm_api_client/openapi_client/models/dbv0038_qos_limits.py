...
class Dbv0038QosLimits(BaseModel):
    """
    Assigned limits
    """ # noqa: E501
    factor: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="factor to apply to TRES count for associations using this QOS")
    max: Optional[Dbv0038QosLimitsMax] = None
    min: Optional[Dbv0038QosLimitsMin] = None
    __properties: ClassVar[List[str]] = ["factor", "max", "min"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max": Dbv0038QosLimitsMax.from_dict(obj["max"]) if obj.get("max") is not None else None,
            "min": Dbv0038QosLimitsMin.from_dict(obj["min"]) if obj.get("min") is not None else None
        })
        return _obj
