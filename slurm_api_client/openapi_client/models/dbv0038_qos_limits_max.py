...
class Dbv0038QosLimitsMax(BaseModel):
    """
    Limits on max settings
    """ # noqa: E501
    wall_clock: Optional[Dbv0038QosLimitsMaxWallClock] = None
    jobs: Optional[Dbv0038QosLimitsMaxJobs] = None
    accruing: Optional[Dbv0038QosLimitsMaxAccruing] = None
    tres: Optional[Dbv0038QosLimitsMaxTres] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "wall_clock": Dbv0038QosLimitsMaxWallClock.from_dict(obj["wall_clock"]) if obj.get("wall_clock") is not None else None,
            "jobs": Dbv0038QosLimitsMaxJobs.from_dict(obj["jobs"]) if obj.get("jobs") is not None else None,
            "accruing": Dbv0038QosLimitsMaxAccruing.from_dict(obj["accruing"]) if obj.get("accruing") is not None else None,
            "tres": Dbv0038QosLimitsMaxTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None
        })
        return _obj
