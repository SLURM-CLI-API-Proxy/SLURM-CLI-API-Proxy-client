...
class Dbv0038AccountInfo(BaseModel):
    """
    Dbv0038AccountInfo
    """ # noqa: E501
    meta: Optional[Dbv0038Meta] = None
    errors: Optional[List[Dbv0038Error]] = Field(default=None, description="Slurm errors")
    accounts: Optional[List[Dbv0038Account]] = Field(default=None, description="List of accounts")
    __properties: ClassVar[List[str]] = ["meta", "errors", "accounts"]
