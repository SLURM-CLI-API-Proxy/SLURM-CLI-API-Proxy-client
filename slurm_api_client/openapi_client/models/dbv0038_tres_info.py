...
class Dbv0038TresInfo(BaseModel):
    """
    Dbv0038TresInfo
    """ # noqa: E501
    meta: Optional[Dbv0038Meta] = None
    errors: Optional[List[Dbv0038Error]] = Field(default=None, description="Slurm errors")
    tres: Optional[List[Dbv0038TresListInner]] = Field(default=None, description="TRES list of attributes")
    __properties: ClassVar[List[str]] = ["meta", "errors", "tres"]
