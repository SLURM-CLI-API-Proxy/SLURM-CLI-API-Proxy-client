...
class Dbv0038QosLimitsMaxTres(BaseModel):
    """
    Limits on TRES
    """ # noqa: E501
    minutes: Optional[Dbv0038QosLimitsMaxTresMinutes] = None
    per: Optional[Dbv0038QosLimitsMaxTresPer] = None
    __properties: ClassVar[List[str]] = ["minutes", "per"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minutes": Dbv0038QosLimitsMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "per": Dbv0038QosLimitsMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
