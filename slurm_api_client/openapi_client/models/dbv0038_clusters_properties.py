...
class Dbv0038ClustersProperties(BaseModel):
    """
    Dbv0038ClustersProperties
    """ # noqa: E501
    clusters: Optional[Dbv0038ClusterInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusters": Dbv0038ClusterInfo.from_dict(obj["clusters"]) if obj.get("clusters") is not None else None
        })
        return _obj
