...
class Dbv0038JobStepStatistics(BaseModel):
    """
    Statistics of job step
    """ # noqa: E501
    cpu: Optional[Dbv0038JobStepStatisticsCPU] = Field(default=None, alias="CPU")
    energy: Optional[Dbv0038JobStepStatisticsEnergy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CPU": Dbv0038JobStepStatisticsCPU.from_dict(obj["CPU"]) if obj.get("CPU") is not None else None,
            "energy": Dbv0038JobStepStatisticsEnergy.from_dict(obj["energy"]) if obj.get("energy") is not None else None
        })
        return _obj
