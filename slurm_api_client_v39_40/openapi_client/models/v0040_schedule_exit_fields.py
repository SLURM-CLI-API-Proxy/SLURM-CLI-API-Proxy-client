...
class V0040ScheduleExitFields(BaseModel):
    ...
    default_queue_depth: Optional[StrictInt] = None
    max_job_start: Optional[StrictInt] = None
    max_rpc_cnt: Optional[StrictInt] = None
    max_sched_time: Optional[StrictInt] = None
    licenses: Optional[StrictInt] = None
