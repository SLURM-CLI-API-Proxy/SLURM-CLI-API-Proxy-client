...
class V0040PowerMgmtData(BaseModel):
    """
    V0040PowerMgmtData
    """ # noqa: E501
    maximum_watts: Optional[V0040Uint32NoVal] = None
    ...
    new_job_time: Optional[V0040Uint64NoVal] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of new_job_time
        if self.new_job_time:
            _dict['new_job_time'] = self.new_job_time.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maximum_watts": V0040Uint32NoVal.from_dict(obj["maximum_watts"]) if obj.get("maximum_watts") is not None else None,
            ...
            "new_job_time": V0040Uint64NoVal.from_dict(obj["new_job_time"]) if obj.get("new_job_time") is not None else None,
            "state": obj.get("state"),
