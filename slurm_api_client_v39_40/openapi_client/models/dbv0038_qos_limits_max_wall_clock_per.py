...
class Dbv0038QosLimitsMaxWallClockPer(BaseModel):
    """
    Limit on wallclock per settings
    """ # noqa: E501
    qos: Optional[StrictInt] = Field(default=None, description="Max wallclock per QOS")
    job: Optional[StrictInt] = Field(default=None, description="Max wallclock per job")
