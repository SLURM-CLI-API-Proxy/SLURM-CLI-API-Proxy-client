...
class Dbv0038ConfigInfo(BaseModel):
    """
    Dbv0038ConfigInfo
    """ # noqa: E501
    meta: Optional[Dbv0038Meta] = None
    errors: Optional[List[Dbv0038Error]] = Field(default=None, description="Slurm errors")
    tres: Optional[List[List[Dbv0038TresListInner]]] = Field(default=None, description="Array of TRES")
    accounts: Optional[List[Dbv0038Account]] = Field(default=None, description="Array of accounts")
    associations: Optional[List[Dbv0038Association]] = Field(default=None, description="Array of associations")
    users: Optional[List[Dbv0038User]] = Field(default=None, description="Array of users")
    qos: Optional[List[Dbv0038Qos]] = Field(default=None, description="Array of qos")
    wckeys: Optional[List[Dbv0038Wckey]] = Field(default=None, description="Array of wckeys")
    __properties: ClassVar[List[str]] = ["meta", "errors", "tres", "accounts", "associations", "users", "qos", "wckeys"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tres": [
                    [Dbv0038TresListInner.from_dict(_inner_item) for _inner_item in _item]
                    for _item in obj["tres"]
                ] if obj.get("tres") is not None else None,
            "accounts": [Dbv0038Account.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None,
            "associations": [Dbv0038Association.from_dict(_item) for _item in obj["associations"]] if obj.get("associations") is not None else None,
            "users": [Dbv0038User.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
            "qos": [Dbv0038Qos.from_dict(_item) for _item in obj["qos"]] if obj.get("qos") is not None else None,
            "wckeys": [Dbv0038Wckey.from_dict(_item) for _item in obj["wckeys"]] if obj.get("wckeys") is not None else None
        })
        return _obj
