...
class Dbv0038AssociationMaxTresPer(BaseModel):
    """
    Max TRES per settings
    """ # noqa: E501
    job: Optional[List[Dbv0038TresListInner]] = Field(default=None, description="TRES list of attributes")
    node: Optional[List[Dbv0038TresListInner]] = Field(default=None, description="TRES list of attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "node": [Dbv0038TresListInner.from_dict(_item) for _item in obj["node"]] if obj.get("node") is not None else None
        })
        return _obj
