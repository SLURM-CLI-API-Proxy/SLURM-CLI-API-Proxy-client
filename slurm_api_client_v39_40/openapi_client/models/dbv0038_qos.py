...
class Dbv0038Qos(BaseModel):
    ...
    limits: Optional[Dbv0038QosLimits] = None
    preempt: Optional[Dbv0038QosPreempt] = None
    ...
    name: Optional[StrictStr] = Field(default=None, description="Assigned name of QOS")
    __properties: ClassVar[List[str]] = ["description", "flags", "id", "limits", "preempt", "priority", "usage_factor", "usage_threshold", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flags": obj.get("flags"),
            "id": obj.get("id"),
            "limits": Dbv0038QosLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
            "preempt": Dbv0038QosPreempt.from_dict(obj["preempt"]) if obj.get("preempt") is not None else None,
