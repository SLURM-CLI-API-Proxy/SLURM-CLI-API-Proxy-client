...
class Dbv0038Job(BaseModel):
    """
    Single job description
    """ # noqa: E501
    account: Optional[StrictStr] = Field(default=None, description="Account charged by job")
    comment: Optional[Dbv0038JobComment] = None
    allocation_nodes: Optional[StrictStr] = Field(default=None, description="Nodes allocated to job")
    array: Optional[Dbv0038JobArray] = None
    time: Optional[Dbv0038JobTime] = None
    association: Optional[Dbv0038AssociationShortInfo] = None
    ...
    derived_exit_code: Optional[Dbv0038JobExitCode] = None
    ...
    het: Optional[Dbv0038JobHet] = None
    ...
    mcs: Optional[Dbv0038JobMcs] = None
    ...
    required: Optional[Dbv0038JobRequired] = None
    kill_request_user: Optional[StrictStr] = Field(default=None, description="User who requested job killed")
    reservation: Optional[Dbv0038JobReservation] = None
    state: Optional[Dbv0038JobState] = None
    steps: Optional[List[Dbv0038JobStep]] = Field(default=None, description="Job step description")
    tres: Optional[Dbv0038JobTres] = None
    user: Optional[StrictStr] = Field(default=None, description="Job user")
    wckey: Optional[Dbv0038JobWckey] = None
    ...
    __properties: ClassVar[List[str]] = ["account", "comment", "allocation_nodes", "array", "time", "association", "cluster", "constraints", "derived_exit_code", "exit_code", "flags", "group", "het", "job_id", "name", "mcs", "nodes", "partition", "priority", "qos", "required", "kill_request_user", "reservation", "state", "steps", "tres", "user", "wckey", "working_directory", "container"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comment": Dbv0038JobComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
            "allocation_nodes": obj.get("allocation_nodes"),
            "array": Dbv0038JobArray.from_dict(obj["array"]) if obj.get("array") is not None else None,
            "time": Dbv0038JobTime.from_dict(obj["time"]) if obj.get("time") is not None else None,
            "association": Dbv0038AssociationShortInfo.from_dict(obj["association"]) if obj.get("association") is not None else None,
            "cluster": obj.get("cluster"),
            "constraints": obj.get("constraints"),
            "derived_exit_code": Dbv0038JobExitCode.from_dict(obj["derived_exit_code"]) if obj.get("derived_exit_code") is not None else None,
            "exit_code": Dbv0038JobExitCode.from_dict(obj["exit_code"]) if obj.get("exit_code") is not None else None,
            "flags": obj.get("flags"),
            "group": obj.get("group"),
            "het": Dbv0038JobHet.from_dict(obj["het"]) if obj.get("het") is not None else None,
            "job_id": obj.get("job_id"),
            "name": obj.get("name"),
            "mcs": Dbv0038JobMcs.from_dict(obj["mcs"]) if obj.get("mcs") is not None else None,
            "nodes": obj.get("nodes"),
            "partition": obj.get("partition"),
            "priority": obj.get("priority"),
            "qos": obj.get("qos"),
            "required": Dbv0038JobRequired.from_dict(obj["required"]) if obj.get("required") is not None else None,
            "kill_request_user": obj.get("kill_request_user"),
            "reservation": Dbv0038JobReservation.from_dict(obj["reservation"]) if obj.get("reservation") is not None else None,
            "state": Dbv0038JobState.from_dict(obj["state"]) if obj.get("state") is not None else None,
            "steps": [Dbv0038JobStep.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None,
            "tres": Dbv0038JobTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "user": obj.get("user"),
            "wckey": Dbv0038JobWckey.from_dict(obj["wckey"]) if obj.get("wckey") is not None else None,
