...
class Dbv0038DiagStatistics(BaseModel):
    """
    Dbv0038DiagStatistics
    """ # noqa: E501
    time_start: Optional[StrictInt] = Field(default=None, description="Unix timestamp of start time")
    rollups: Optional[List[Dbv0038DiagStatisticsRollupsInner]] = None
    rpcs: Optional[List[Dbv0038DiagStatisticsRPCsInner]] = Field(default=None, alias="RPCs")
    users: Optional[List[Dbv0038DiagStatisticsUsersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rollups": [Dbv0038DiagStatisticsRollupsInner.from_dict(_item) for _item in obj["rollups"]] if obj.get("rollups") is not None else None,
            "RPCs": [Dbv0038DiagStatisticsRPCsInner.from_dict(_item) for _item in obj["RPCs"]] if obj.get("RPCs") is not None else None,
            "users": [Dbv0038DiagStatisticsUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
