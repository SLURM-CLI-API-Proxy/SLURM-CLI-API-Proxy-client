...
class Dbv0038User(BaseModel):
    """
    User description
    """ # noqa: E501
    administrator_level: Optional[StrictStr] = Field(default=None, description="Description of administrator level")
    associations: Optional[List[Dbv0038AssociationShortInfo]] = Field(default=None, description="Assigned associations")
    coordinators: Optional[List[Dbv0038CoordinatorInfo]] = Field(default=None, description="List of assigned coordinators")
    default: Optional[Dbv0038UserDefault] = None
    flags: Optional[List[StrictStr]] = Field(default=None, description="List of properties of user")
    name: Optional[StrictStr] = Field(default=None, description="User name")
    __properties: ClassVar[List[str]] = ["administrator_level", "associations", "coordinators", "default", "flags", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "associations": [Dbv0038AssociationShortInfo.from_dict(_item) for _item in obj["associations"]] if obj.get("associations") is not None else None,
            "coordinators": [Dbv0038CoordinatorInfo.from_dict(_item) for _item in obj["coordinators"]] if obj.get("coordinators") is not None else None,
            "default": Dbv0038UserDefault.from_dict(obj["default"]) if obj.get("default") is not None else None,
            "flags": obj.get("flags"),
            "name": obj.get("name")
        })
        return _obj
