...
class Dbv0038JobStepTres(BaseModel):
    """
    TRES usage
    """ # noqa: E501
    requested: Optional[Dbv0038JobStepTresRequested] = None
    consumed: Optional[Dbv0038JobStepTresRequested] = None
    allocated: Optional[List[Dbv0038TresListInner]] = Field(default=None, description="TRES list of attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requested": Dbv0038JobStepTresRequested.from_dict(obj["requested"]) if obj.get("requested") is not None else None,
            "consumed": Dbv0038JobStepTresRequested.from_dict(obj["consumed"]) if obj.get("consumed") is not None else None,
            "allocated": [Dbv0038TresListInner.from_dict(_item) for _item in obj["allocated"]] if obj.get("allocated") is not None else None
        })
        return _obj
