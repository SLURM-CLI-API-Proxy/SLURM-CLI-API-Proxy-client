...
class V0040ClusterRec(BaseModel):
    ...
    def flags_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['REGISTERING', 'MULTIPLE_SLURMD', 'FRONT_END', 'CRAY_NATIVE', 'FEDERATION', 'EXTERNAL']):
                raise ValueError("each list item must be one of ('REGISTERING', 'MULTIPLE_SLURMD', 'FRONT_END', 'CRAY_NATIVE', 'FEDERATION', 'EXTERNAL')")
        return value
