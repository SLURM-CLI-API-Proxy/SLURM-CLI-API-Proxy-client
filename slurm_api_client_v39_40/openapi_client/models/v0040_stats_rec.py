...
class V0040StatsRec(BaseModel):
    ...
    rollups: Optional[List[V0039RollupStatsInner]] = Field(default=None, description="list of recorded rollup statistics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rollups": [V0039RollupStatsInner.from_dict(_item) for _item in obj["rollups"]] if obj.get("rollups") is not None else None,
