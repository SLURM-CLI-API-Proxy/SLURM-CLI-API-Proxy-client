...
class TestDbv0038JobInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038JobInfo:
        """Test Dbv0038JobInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038JobInfo`
        """
        model = Dbv0038JobInfo()
        if include_optional:
            return Dbv0038JobInfo(
                ...
                jobs = [
                    openapi_client.models.dbv0/0/38_job.dbv0.0.38_job(
                        account = '', 
