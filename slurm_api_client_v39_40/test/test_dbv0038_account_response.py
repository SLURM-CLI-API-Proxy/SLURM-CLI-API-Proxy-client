...
class TestDbv0038AccountResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038AccountResponse:
        """Test Dbv0038AccountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038AccountResponse`
        """
        model = Dbv0038AccountResponse()
        if include_optional:
    ...
    def testDbv0038AccountResponse(self):
        """Test Dbv0038AccountResponse"""
