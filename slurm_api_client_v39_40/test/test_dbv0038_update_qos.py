...
class TestDbv0038UpdateQos(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038UpdateQos:
        """Test Dbv0038UpdateQos
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038UpdateQos`
        """
        model = Dbv0038UpdateQos()
        if include_optional:
            return Dbv0038UpdateQos(
                qos = [
