...
class TestDbv0038ResponseAccountDelete(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ResponseAccountDelete:
        """Test Dbv0038ResponseAccountDelete
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ResponseAccountDelete`
        """
        model = Dbv0038ResponseAccountDelete()
        if include_optional:
    ...
    def testDbv0038ResponseAccountDelete(self):
        """Test Dbv0038ResponseAccountDelete"""
