...
class TestDbv0038ResponseWckeyDelete(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ResponseWckeyDelete:
        """Test Dbv0038ResponseWckeyDelete
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ResponseWckeyDelete`
        """
        model = Dbv0038ResponseWckeyDelete()
        if include_optional:
    ...
    def testDbv0038ResponseWckeyDelete(self):
        """Test Dbv0038ResponseWckeyDelete"""
