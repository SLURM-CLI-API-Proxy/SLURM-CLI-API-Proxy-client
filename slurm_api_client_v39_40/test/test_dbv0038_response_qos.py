...
class TestDbv0038ResponseQos(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ResponseQos:
        """Test Dbv0038ResponseQos
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ResponseQos`
        """
        model = Dbv0038ResponseQos()
        if include_optional:
    ...
    def testDbv0038ResponseQos(self):
        """Test Dbv0038ResponseQos"""
