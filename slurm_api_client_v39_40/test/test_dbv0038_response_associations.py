...
class TestDbv0038ResponseAssociations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ResponseAssociations:
        """Test Dbv0038ResponseAssociations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ResponseAssociations`
        """
        model = Dbv0038ResponseAssociations()
        if include_optional:
    ...
    def testDbv0038ResponseAssociations(self):
        """Test Dbv0038ResponseAssociations"""
