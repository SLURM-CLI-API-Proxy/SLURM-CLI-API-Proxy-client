...
Visit
[https://test.pypi.org/project/slurm_api_cli_proxy](https://test.pypi.org/project/slurm_api_cli_proxy)
...
--extra-index-url https://pypi.org/simple slurm_api_cli_proxy
```
...
Don't forget to also make a [release on GitHub](https://github.com/hcadavid/slurm_api_cli_proxy/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.
