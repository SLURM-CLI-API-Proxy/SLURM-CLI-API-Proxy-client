...
class Dbv0038AssociationMaxTresMinutes(BaseModel):
    """
    Max TRES minutes settings
    """ # noqa: E501
    per: Optional[Dbv0038AssociationMaxTresMinutesPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": Dbv0038AssociationMaxTresMinutesPer.from_dict(obj["per"]) if obj.get("per") is not None else None,
