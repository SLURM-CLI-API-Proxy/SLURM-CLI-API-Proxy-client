...
class Dbv0038AssociationMaxTres(BaseModel):
    """
    Max TRES settings
    """ # noqa: E501
    per: Optional[Dbv0038AssociationMaxTresPer] = None
    total: Optional[List[Dbv0038TresListInner]] = Field(default=None, description="TRES list of attributes")
    minutes: Optional[Dbv0038AssociationMaxTresMinutes] = None
    __properties: ClassVar[List[str]] = ["per", "total", "minutes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": Dbv0038AssociationMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None,
            "total": [Dbv0038TresListInner.from_dict(_item) for _item in obj["total"]] if obj.get("total") is not None else None,
            "minutes": Dbv0038AssociationMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None
        })
        return _obj
