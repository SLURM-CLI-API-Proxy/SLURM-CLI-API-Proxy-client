...
class Dbv0038QosLimitsMaxAccruing(BaseModel):
    """
    Limits on accruing priority
    """ # noqa: E501
    per: Optional[Dbv0038QosLimitsMaxAccruingPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": Dbv0038QosLimitsMaxAccruingPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
