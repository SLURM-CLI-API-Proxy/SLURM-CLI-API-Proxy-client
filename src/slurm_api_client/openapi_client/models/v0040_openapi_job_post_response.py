...
class V0040OpenapiJobPostResponse(BaseModel):
    ...
    job_id: Optional[StrictStr] = Field(default=None, description="First updated JobId - Use results instead")
    step_id: Optional[StrictStr] = Field(default=None, description="First updated StepID - Use results instead")
