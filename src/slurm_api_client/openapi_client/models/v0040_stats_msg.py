...
class V0040StatsMsg(BaseModel):
    ...
    rpcs_by_message_type: Optional[List[V0039StatsMsgRpcsByTypeInner]] = Field(default=None, description="RPCs by message type")
    rpcs_by_user: Optional[List[V0039StatsMsgRpcsByUserInner]] = Field(default=None, description="RPCs by user")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rpcs_by_message_type": [V0039StatsMsgRpcsByTypeInner.from_dict(_item) for _item in obj["rpcs_by_message_type"]] if obj.get("rpcs_by_message_type") is not None else None,
            "rpcs_by_user": [V0039StatsMsgRpcsByUserInner.from_dict(_item) for _item in obj["rpcs_by_user"]] if obj.get("rpcs_by_user") is not None else None
        })
        return _obj
