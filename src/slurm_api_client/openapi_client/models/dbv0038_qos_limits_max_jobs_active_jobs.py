...
class Dbv0038QosLimitsMaxJobsActiveJobs(BaseModel):
    """
    Limits on active jobs settings
    """ # noqa: E501
    per: Optional[Dbv0038QosLimitsMaxJobsActiveJobsPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": Dbv0038QosLimitsMaxJobsActiveJobsPer.from_dict(obj["per"]) if obj.get("per") is not None else None
        })
        return _obj
