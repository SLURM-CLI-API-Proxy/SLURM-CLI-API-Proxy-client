...
class Dbv0038QosLimitsMaxJobs(BaseModel):
    """
    Limits on jobs settings
    """ # noqa: E501
    active_jobs: Optional[Dbv0038QosLimitsMaxJobsActiveJobs] = None
    __properties: ClassVar[List[str]] = ["active_jobs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "active_jobs": Dbv0038QosLimitsMaxJobsActiveJobs.from_dict(obj["active_jobs"]) if obj.get("active_jobs") is not None else None
        })
        return _obj
