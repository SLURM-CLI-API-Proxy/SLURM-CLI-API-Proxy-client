...
class Dbv0038JobTres(BaseModel):
    """
    TRES settings
    """ # noqa: E501
    allocated: Optional[List[Dbv0038TresListInner]] = Field(default=None, description="TRES list of attributes")
    requested: Optional[List[Dbv0038TresListInner]] = Field(default=None, description="TRES list of attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requested": [Dbv0038TresListInner.from_dict(_item) for _item in obj["requested"]] if obj.get("requested") is not None else None
        })
        return _obj
