...
class Dbv0038AssociationMaxPer(BaseModel):
    """
    Max per settings
    """ # noqa: E501
    account: Optional[Dbv0038AssociationMaxPerAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": Dbv0038AssociationMaxPerAccount.from_dict(obj["account"]) if obj.get("account") is not None else None
        })
        return _obj
