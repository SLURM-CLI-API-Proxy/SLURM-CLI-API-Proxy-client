...
class Dbv0038JobArrayLimits(BaseModel):
    """
    Limits on array settings
    """ # noqa: E501
    max: Optional[Dbv0038JobArrayLimitsMax] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max": Dbv0038JobArrayLimitsMax.from_dict(obj["max"]) if obj.get("max") is not None else None
        })
        return _obj
