...
class Dbv0038JobStepCPURequestedFrequency(BaseModel):
    """
    CPU frequency requested
    """ # noqa: E501
    min: Optional[StrictInt] = Field(default=None, description="Min CPU frequency")
    max: Optional[StrictInt] = Field(default=None, description="Max CPU frequency")
