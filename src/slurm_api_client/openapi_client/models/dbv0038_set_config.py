...
class Dbv0038SetConfig(BaseModel):
    """
    Dbv0038SetConfig
    """ # noqa: E501
    clusters: Optional[List[Dbv0038ClustersProperties]] = None
    tres: Optional[List[List[Dbv0038TresListInner]]] = Field(default=None, alias="TRES")
    accounts: Optional[List[Dbv0038UpdateAccount]] = None
    users: Optional[List[Dbv0038User]] = None
    qos: Optional[List[Dbv0038Qos]] = None
    wckeys: Optional[List[Dbv0038Wckey]] = None
    associations: Optional[List[Dbv0038Association]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusters": [Dbv0038ClustersProperties.from_dict(_item) for _item in obj["clusters"]] if obj.get("clusters") is not None else None,
            "TRES": [
            ...
            "accounts": [Dbv0038UpdateAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None,
