...
class TestDbv0038JobStepTres(unittest.TestCase):
    """Dbv0038JobStepTres unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Dbv0038JobStepTres:
        """Test Dbv0038JobStepTres
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038JobStepTres`
        """
        model = Dbv0038JobStepTres()
        if include_optional:
            return Dbv0038JobStepTres(
    ...
    def testDbv0038JobStepTres(self):
        """Test Dbv0038JobStepTres"""
