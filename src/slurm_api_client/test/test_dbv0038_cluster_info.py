...
class TestDbv0038ClusterInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ClusterInfo:
        """Test Dbv0038ClusterInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ClusterInfo`
        """
        model = Dbv0038ClusterInfo()
        if include_optional:
    ...
    def testDbv0038ClusterInfo(self):
        """Test Dbv0038ClusterInfo"""
