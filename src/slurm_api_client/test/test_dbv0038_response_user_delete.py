...
class TestDbv0038ResponseUserDelete(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ResponseUserDelete:
        """Test Dbv0038ResponseUserDelete
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ResponseUserDelete`
        """
        model = Dbv0038ResponseUserDelete()
        if include_optional:
    ...
    def testDbv0038ResponseUserDelete(self):
        """Test Dbv0038ResponseUserDelete"""
