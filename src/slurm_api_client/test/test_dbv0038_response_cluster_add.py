...
class TestDbv0038ResponseClusterAdd(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ResponseClusterAdd:
        """Test Dbv0038ResponseClusterAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ResponseClusterAdd`
        """
        model = Dbv0038ResponseClusterAdd()
        if include_optional:
    ...
    def testDbv0038ResponseClusterAdd(self):
        """Test Dbv0038ResponseClusterAdd"""
