...
class TestDbv0038JobTime(unittest.TestCase):
    """Dbv0038JobTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Dbv0038JobTime:
        """Test Dbv0038JobTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038JobTime`
        """
        model = Dbv0038JobTime()
        if include_optional:
            return Dbv0038JobTime(
                elapsed = 56,
                eligible = 56,
                end = 56,
                start = 56,
