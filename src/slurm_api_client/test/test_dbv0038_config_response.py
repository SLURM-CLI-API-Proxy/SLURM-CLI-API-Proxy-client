...
class TestDbv0038ConfigResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ConfigResponse:
        """Test Dbv0038ConfigResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ConfigResponse`
        """
        model = Dbv0038ConfigResponse()
        if include_optional:
    ...
    def testDbv0038ConfigResponse(self):
        """Test Dbv0038ConfigResponse"""
