...
class TestDbv0038ResponseQosDelete(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038ResponseQosDelete:
        """Test Dbv0038ResponseQosDelete
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038ResponseQosDelete`
        """
        model = Dbv0038ResponseQosDelete()
        if include_optional:
    ...
    def testDbv0038ResponseQosDelete(self):
        """Test Dbv0038ResponseQosDelete"""
