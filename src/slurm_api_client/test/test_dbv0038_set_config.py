...
class TestDbv0038SetConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0038SetConfig:
        """Test Dbv0038SetConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0038SetConfig`
        """
        model = Dbv0038SetConfig()
        if include_optional:
            return Dbv0038SetConfig(
                clusters = [
                    openapi_client.models.dbv0/0/38_clusters_properties.dbv0.0.38_clusters_properties(
                ...
                accounts = [
                    openapi_client.models.dbv0/0/38_update_account.dbv0.0.38_update_account(
                        accounts = [
